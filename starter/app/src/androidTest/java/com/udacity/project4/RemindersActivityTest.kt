...
class RemindersActivityTest :
    ...
    @Test
    fun showSnackBarLocationError() {

        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        dataBindingIdlingResource.monitorActivity(activityScenario)
//        val navController = mock(NavController::class.java)
//        verify(navController).navigate( SaveReminderFragmentDirections.actionTasksFragmentToTaskDetailFragment( "id1")
    ...
    fun saveReminderScreentolist() {
       ...
       val navController = mock(NavController::class.java)
        onView(withId(R.id.addReminderFAB)).perform(click())
        onView(withId(R.id.reminderTitle)).perform(replaceText("test1"))
        onView(withId(R.id.reminderDescription)).perform(replaceText("descrip"))
    ...
    lateinit var dec :View
    @Test
    fun Show_Toast_Message_On_Save() {
